...
- Olijslager, L.H., Weijers, D., & Swarts, D.C., Distribution of specific prokaryotic immune systems correlates with host optimal growth temperature., unpublished.
...
# options
```sh
$find_immune_systems.py [-h] [-i INPUT_DB] [-o OUTPUT_DIR] [-c] [-p] [-gff GFF] [--conflict_winner] [-cpu CPU] [--no_padloc]
...
optional arguments:
  ...
  --conflict_winner     In case of conflict between identified systems, should DefenseFinder (DF) or PADLOC (PL) overrule?   
                        Default: DF.
